...
const USE_SUPABASE = STORAGE_MODE === "supabase";
...
const getDecksFromLocalStorage = async () => {
	try {
...
const getDecksFromApi = async () =>
	requestApiJson("/api/decks", { method: "GET" });
const getUsersFromApi = async () =>
	requestApiJson("/api/users", { method: "GET" });

export const getDecks = async () => {
	if (!USE_SUPABASE) return getDecksFromLocalStorage();
...
export const saveDeckToStorage = async (deckData) => {
	if (!USE_SUPABASE) {
		const decks = await getDecksFromLocalStorage();
	...
	return requestApiJson("/api/decks", {
		method: "POST",
...
export const deleteDeckFromStorage = async (deckId) => {
	...
	return requestApiJson(`/api/decks/${deckId}`, { method: "DELETE" });
};
...
export const copyDeckInStorage = async (deckId) => {
	...
	return requestApiJson(`/api/decks/${deckId}/copy`, { method: "POST" });
};
...
export const renameDeckInStorage = async (deckId, newName) => {
	...
	return requestApiJson(`/api/decks/${deckId}/rename`, {
		method: "POST",
...
export const getUsers = async () => {
	if (!USE_SUPABASE) return getUsersFromLocalStorage();
...
export const saveUser = async (user) => {
	...
	return requestApiJson("/api/users", {
		method: "POST",
...
export const deleteUser = async (userId) => {
	...
	return requestApiJson(`/api/users/${userId}`, { method: "DELETE" });
};
...
export const exportDeckToPublic = async (deckId) => {
	...
	return requestApiJson(`/api/decks/${deckId}/export-public`, {
		method: "POST",
	});
};
...
export const importDeckFromPublic = async (deckId, targetUserId) => {
	...
	return requestApiJson(`/api/decks/${deckId}/import-public`, {
		method: "POST",
